...
/// <summary>
/// Typed Result<TValue, TError> that makes domain failures explicit in the type system.
/// Use Match() to handle both cases GÇö never access .Value on a failure or .Error on a success.
/// </summary>
