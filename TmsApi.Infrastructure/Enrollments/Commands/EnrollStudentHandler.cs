...
/// Every domain failure is an early return G현 no exceptions for expected business outcomes.
/// </summary>
    ...
    : IRequestHandler<EnrollStudentCommand, Result<EnrollmentCreated, EnrollmentError>>
{
    ...
    {
        // Step 1: Find course by code G현 404 if not found
