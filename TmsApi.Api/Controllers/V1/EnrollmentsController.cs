...
/// <summary>
/// V1 Enrollments controller G�� frozen contract.
/// Keeps the nested POST /api/v1/courses/{courseId}/enrollments pattern.
/// Business rules: 404 before 409 G�� if course doesn't exist, return 404.
/// </summary>
[ApiController]
...
{
    /// <summary>
    /// POST /api/v1/courses/{courseId}/enrollments G�� enroll a student.
